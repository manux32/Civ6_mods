...
VALUES	-- Grant Technologies
		...
		('MOD_MNX_ATTACH_GOVS_GOLD_PURCHASE_DISTRICTS',		'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',						0,				'CITY_HAS_GOVERNOR'),

		-- Attached City modifiers
		('MOD_MNX_GOVERNORS_FAITH_PURCHASE_DISTRICTS',		'DMOD_MNX_GOVERNORS_FAITH_PURCHASE_DISTRICTS',					0,				NULL),
