...
-----------------------------------------------
	...
	('en_US',	'LOC_CIVILIZATION_MNX_NORSE_NAME',			'Norse'			),
	('en_US',	'LOC_CIVILIZATION_MNX_NORSE_DESCRIPTION',	'Norse Empire'	),
	('en_US',	'LOC_CIVILIZATION_MNX_NORSE_ADJECTIVE',  	'Norse'			),
...
-----------------------------------------------
	...
	'+2 Great [ICON_GreatProphet] Prophet, [ICON_GreatAdmiral] Admiral, [ICON_GreatGeneral] General, and [ICON_GreatMerchant] Merchant points per turn. Land Units can embark from the start and ignore embark/disembark [ICON_Movement] costs. Units can enter Ocean tiles at Shipbuilding. Coastal Cities get +1 [ICON_Housing] Housing. Coastal Districts provide +1 [ICON_Amenities] Amenity. Harbor, Encampment and Holy Site are 50% [ICON_PRODUCTION] cheaper to build, and give/receive +1 adjacency to/from all districts. Harbor and Holy Site buildings emanate some of their respective yields ([ICON_Faith]/[ICON_Gold]) on adjacent tiles and districts, and on water tiles with later eras buildings. Districts receive minor adjacency from Water tiles. Holy Site and Harbor buildings provide +2 [ICON_Food] Food.'),	-- Shrines provide +1 [ICON_TradeRoute] Trade Route capacity.'),
...
-----------------------------------------------
	('en_US',	'LOC_MNX_ODIN_HOLYSITE_2X_DISTRICTS_ADJACENCY',		'(ODIN) +{1_num} [ICON_Faith] Faith from the adjacent {1_Num : plural 1?district; other?districts;}.'),
	('en_US',	'LOC_MNX_ODIN_HARBOR_2X_DISTRICTS_ADJACENCY',		'(ODIN) +{1_num} [ICON_Gold] Gold from the adjacent {1_Num : plural 1?district; other?districts;}.'),
	
	('en_US',	'LOC_MNX_ODIN_GOLD_DIST_REG_ADJ_ANY_DIST',			'+{1_num} [ICON_Gold] Gold from the adjacent {1_Num : plural 1?district; other?districts;}.'),

	('en_US',	'LOC_MNX_ODIN_FAITH_DIST_ADJ_HOLYSITE',				'(ODIN) +{1_num} [ICON_Faith] Faith from the adjacent {1_Num : plural 1?Holy Site; other?Holy Sites;}.'),
	('en_US',	'LOC_MNX_ODIN_GOLD_DIST_ADJ_HOLYSITE',				'(ODIN) +{1_num} [ICON_Gold] Gold from the adjacent {1_Num : plural 1?Holy Site; other?Holy Sites;}.'),
	('en_US',	'LOC_MNX_ODIN_SCIENCE_DIST_ADJ_HOLYSITE',			'(ODIN) +{1_num} [ICON_Science] Science from the adjacent {1_Num : plural 1?Holy Site; other?Holy Sites;}.'),
	('en_US',	'LOC_MNX_ODIN_CULTURE_DIST_ADJ_HOLYSITE',			'(ODIN) +{1_num} [ICON_Culture] Culture from the adjacent {1_Num : plural 1?Holy Site; other?Holy Sites;}.'),
	('en_US',	'LOC_MNX_ODIN_PROD_DIST_ADJ_HOLYSITE',				'(ODIN) +{1_num} [ICON_Production] Production from the adjacent {1_Num : plural 1?Holy Site; other?Holy Sites;}.'),
	('en_US',	'LOC_MNX_ODIN_FOOD_DIST_ADJ_HOLYSITE',				'(ODIN) +{1_num} [ICON_Food] Food from the adjacent {1_Num : plural 1?Holy Site; other?Holy Sites;}.'),
	
	('en_US',	'LOC_MNX_ODIN_FAITH_DIST_ADJ_HARBOR',				'(ODIN) +{1_num} [ICON_Faith] Faith from the adjacent {1_Num : plural 1?Harbor; other?Harbors;}.'),
	('en_US',	'LOC_MNX_ODIN_GOLD_DIST_ADJ_HARBOR',				'(ODIN) +{1_num} [ICON_Gold] Gold from the adjacent {1_Num : plural 1?Harbor; other?Harbors;}.'),
	('en_US',	'LOC_MNX_ODIN_SCIENCE_DIST_ADJ_HARBOR',				'(ODIN) +{1_num} [ICON_Science] Science from the adjacent {1_Num : plural 1?Harbor; other?Harbors;}.'),
	...
	('en_US',	'LOC_MNX_ODIN_SCIENCE_DIST_ADJ_COAST',				'(ODIN) +{1_num} [ICON_Science] Science from the adjacent water {1_Num : plural 1?tile; other?tiles;}.'),
	('en_US',	'LOC_MNX_ODIN_CULTURE_DIST_ADJ_COAST',				'(ODIN) +{1_num} [ICON_Culture] Culture from the adjacent water {1_Num : plural 1?tile; other?tiles;}.'),
	('en_US',	'LOC_MNX_ODIN_PROD_DIST_ADJ_COAST',					'(ODIN) +{1_num} [ICON_Production] Production from the adjacent water {1_Num : plural 1?tile; other?tiles;}.'),
	('en_US',	'LOC_MNX_ODIN_FOOD_DIST_ADJ_COAST',					'(ODIN) +{1_num} [ICON_Food] Food from the adjacent water {1_Num : plural 1?tile; other?tiles;}.'),
...
-- Please note: The display of in-game icons in text is achieved by using [ICON_Type].
-----------------------------------------------
	('en_US',	'LOC_BUILDING_MNX_GREAT_HALL_NAME',						'Great Hall'								),
	('en_US',	'LOC_BUILDING_MNX_GREAT_HALL_DESCRIPTION',				'A building unique to the Norse that unlocks with Mining. +2 [ICON_Housing] Housing, +1 [ICON_Amenities] Amenity, and +2 [ICON_Food][ICON_Production][ICON_Gold][ICON_Faith][ICON_Culture].'),
	
	('en_US',	'LOC_IMPROVEMENT_MNX_ODIN_FISH_FARM_NAME',				'Fish Farm'								),
	('en_US',	'LOC_IMPROVEMENT_MNX_ODIN_FISH_FARM_DESCRIPTION',		'Unlocks the Builder ability to construct Fish Farms on any Coast or Lake tile with Shipbuilding and on any Ocean tile with Cartography. Provides the same yields and bonuses as Fishing Boats. Cannot be built on a sea resource.'),

	-- Stave Church description override
	('en_US',	'LOC_MNX_BUILDING_STAVE_CHURCH_OVERRIDE_DESCRIPTION',		
	'A building unique to Norse related empires. +2 [ICON_Housing] Housing, +1 [ICON_Amenities] Amenity. Holy Site gets an additional standard adjacency from Woods. +1 [ICON_PRODUCTION] Production on Fishing Boats and Fish Farms of this city.'),
...
-----------------------------------------------
	...
	('en_US',	'LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_MNX_NORSE_CHAPTER_HISTORY_PARA_1',		
	...
	('en_US',	'LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_MNX_NORSE_CHAPTER_HISTORY_PARA_2',		
	...
	('en_US',	'LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_MNX_NORSE_CHAPTER_HISTORY_PARA_3',	
	...
	('en_US',	'LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_MNX_NORSE_CHAPTER_HISTORY_PARA_4',	
	'Origins'),
	('en_US',	'LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_MNX_NORSE_CHAPTER_HISTORY_PARA_5',	
	...
	('en_US',	'LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_MNX_NORSE_CHAPTER_HISTORY_PARA_6',	
	...
	('en_US',	'LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_MNX_NORSE_CHAPTER_HISTORY_PARA_7',	
	...
	('en_US',	'LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_MNX_NORSE_CHAPTER_HISTORY_PARA_8',	
	'La Venta'),
	('en_US',	'LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_MNX_NORSE_CHAPTER_HISTORY_PARA_9',	
	...
	('en_US',	'LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_MNX_NORSE_CHAPTER_HISTORY_PARA_10',	
	...
	('en_US',	'LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_MNX_NORSE_CHAPTER_HISTORY_PARA_11',	
	'Decline'),
	('en_US',	'LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_MNX_NORSE_CHAPTER_HISTORY_PARA_12',	
	...
	('en_US',	'LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_MNX_NORSE_CHAPTER_HISTORY_PARA_13',	
	...
	('en_US',	'LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_MNX_NORSE_CHAPTER_HISTORY_PARA_14',	
