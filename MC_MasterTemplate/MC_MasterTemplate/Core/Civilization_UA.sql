...
VALUES	('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',						'KIND_TRAIT'	),
		('TRAIT_MNX_ODIN_IMPROVEMENT_FISH_FARMS',					'KIND_TRAIT'	),
		('TRAIT_BUILDING_MNX_GREAT_HALL',							'KIND_TRAIT'	),
...
VALUES		('DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',		'COLLECTION_PLAYER_DISTRICTS',		'EFFECT_ADJUST_DISTRICT_BASE_YIELD_CHANGE');
			--('DMOD_MNX_PCITIES_ADJUST_ALL_DISTRICTS_PURCHASE_COST',		'COLLECTION_PLAYER_CITIES',			'EFFECT_ADJUST_ALL_DISTRICTS_PURCHASE_COST');
...
VALUES	('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',		'LOC_TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN_NAME',		'LOC_TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN_DESCRIPTION'			),
		('TRAIT_BUILDING_MNX_GREAT_HALL',			'LOC_BUILDING_MNX_GREAT_HALL_NAME',					'LOC_BUILDING_MNX_GREAT_HALL_DESCRIPTION'						),
		('TRAIT_MNX_ODIN_IMPROVEMENT_FISH_FARMS',	'LOC_IMPROVEMENT_MNX_ODIN_FISH_FARM_NAME',			'LOC_IMPROVEMENT_MNX_ODIN_FISH_FARM_DESCRIPTION'				);
...
VALUES	('CIVILIZATION_MNX_NORSE',		'TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN'			),
		('CIVILIZATION_MNX_NORSE',		'TRAIT_BUILDING_MNX_GREAT_HALL'					),
		('CIVILIZATION_MNX_NORSE',		'TRAIT_MNX_ODIN_IMPROVEMENT_FISH_FARMS'			),
		-- Norway Traits
...
VALUES	-- Norway Civ Knarr (Early Ocean Navigation) Trait
		...
		-----------------------------------------------
		('TRAIT_MNX_ODIN_IMPROVEMENT_FISH_FARMS',			'MOD_MNX_ODIN_FISH_FARMS_COAST'						),
		('TRAIT_MNX_ODIN_IMPROVEMENT_FISH_FARMS',			'MOD_MNX_ODIN_FISH_FARMS_OCEAN'						),
		...
		-----------------------------------------------
		-- Cheaper Districts
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_CHEAP_HOLYSITE_PROD'					),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_CHEAP_HARBOR_PROD'					),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_CHEAP_ENCAMPMENT_PROD'				),

		-- Can't control which districts get the bonus
		/*('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_CHEAP_HOLYSITE_BUY'					),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_CHEAP_HARBOR_BUY'						),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_CHEAP_ENCAMPMENT_BUY'					),*/
		...
		-----------------------------------------------
		-- Science and Culture from Tier 3 HS and HR
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_WATER_CULT_TIER3_HOLYSITE'			),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_WATER_SCI_TIER3_HOLYSITE'				),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_WATER_CULT_TIER3_HARBOR'				),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_WATER_SCI_TIER3_HARBOR'				),

		-----------------------------------------------
		/*-- Holy Site and Harbor: Mirror Yields from built districts
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS'			),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS'			),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS'			),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS'			),

		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS'			),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS'			),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS'			),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS'			),*/

		-----------------------------------------------
		-- Holy Site and Harbor: Yields from built districts
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS_T1'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS_T2'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS_T3'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS_T1'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS_T2'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS_T3'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS_T1'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS_T2'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS_T3'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS_T1'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS_T2'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS_T3'		),

		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS_T1'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS_T2'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS_T3'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS_T1'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS_T2'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS_T3'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS_T1'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS_T2'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS_T3'		),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS_T1'			),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS_T2'			),
		('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',				'MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS_T3'			),
...
VALUES	-- Holy Site and Harbor 2X districts adjacency
		...
		('MOD_MNX_ODIN_FISH_FARMS_COAST',						'MODIFIER_PLAYER_CITIES_ADJUST_IMPROVEMENT_VALID_TERRAIN',				0,			1,			'REQSR_MNX_HAS_TECH_SHIPBUILDING'			),
		('MOD_MNX_ODIN_FISH_FARMS_OCEAN',						'MODIFIER_PLAYER_CITIES_ADJUST_IMPROVEMENT_VALID_TERRAIN',				0,			1,			'REQSR_MNX_HAS_TECH_CARTOGRAPHY'			),
		...
		-----------------------------------------------
		-- Cheaper Districts
		('MOD_MNX_ODIN_CHEAP_HOLYSITE_PROD',					'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION',					0,			1,			NULL										),
		('MOD_MNX_ODIN_CHEAP_HARBOR_PROD',						'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION',					0,			1,			NULL										),
		('MOD_MNX_ODIN_CHEAP_ENCAMPMENT_PROD',					'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION',					0,			1,			NULL										),
		
		/*('MOD_MNX_ODIN_CHEAP_HOLYSITE_BUY',						'DMOD_MNX_PCITIES_ADJUST_ALL_DISTRICTS_PURCHASE_COST',					0,			1,			NULL										),
		('MOD_MNX_ODIN_CHEAP_HARBOR_BUY',						'DMOD_MNX_PCITIES_ADJUST_ALL_DISTRICTS_PURCHASE_COST',					0,			1,			NULL										),
		('MOD_MNX_ODIN_CHEAP_ENCAMPMENT_BUY',					'DMOD_MNX_PCITIES_ADJUST_ALL_DISTRICTS_PURCHASE_COST',					0,			1,			NULL										),
		*/
		-----------------------------------------------
		-- Trade Route from Shrines
		...
		-----------------------------------------------
		-- Science and Culture from Tier 3 HS and HR
		('MOD_MNX_ODIN_WATER_CULT_TIER3_HOLYSITE',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',									0,			1,			'REQSR_MNX_PLOT_IS_WATER_HAS_HOLY_TIER3'	),
		('MOD_MNX_ODIN_WATER_SCI_TIER3_HOLYSITE',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',									0,			1,			'REQSR_MNX_PLOT_IS_WATER_HAS_HOLY_TIER3'	),
		('MOD_MNX_ODIN_WATER_CULT_TIER3_HARBOR',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',									0,			1,			'REQSR_MNX_PLOT_IS_WATER_HAS_HARBOR_TIER3'	),
		('MOD_MNX_ODIN_WATER_SCI_TIER3_HARBOR',					'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',									0,			1,			'REQSR_MNX_PLOT_IS_WATER_HAS_HARBOR_TIER3'	),
		
		-----------------------------------------------
		/*-- Holy Site and Harbor: Mirror Yields from built districts
		('MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS',			'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_ADJACENCY_BONUS',		0,			1,			'REQSR_MNX_IS_HOLY_T3_HAS_GOLD_DIST'		),
		('MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS',			'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_ADJACENCY_BONUS',		0,			1,			'REQSR_MNX_IS_HOLY_T3_HAS_INDZONE'			),
		('MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS',			'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_ADJACENCY_BONUS',		0,			1,			'REQSR_MNX_IS_HOLY_T3_HAS_THEATER'			),
		('MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS',			'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_ADJACENCY_BONUS',		0,			1,			'REQSR_MNX_IS_HOLY_T3_HAS_CAMPUS'			),
		
		('MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS',			'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_ADJACENCY_BONUS',		0,			1,			'REQSR_MNX_IS_HARB_T3_HAS_HOLYSITE'			),
		('MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS',				'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_ADJACENCY_BONUS',		0,			1,			'REQSR_MNX_IS_HARB_T3_HAS_INDZONE'			),
		('MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS',				'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_ADJACENCY_BONUS',		0,			1,			'REQSR_MNX_IS_HARB_T3_HAS_THEATER'			),
		('MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS',				'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_ADJACENCY_BONUS',		0,			1,			'REQSR_MNX_IS_HARB_T3_HAS_CAMPUS'			),
		*/
		-----------------------------------------------
		-- Holy Site and Harbor: Yields from built districts
		('MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS_T1',		'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HOLY_T1_HAS_GOLD_DIST'		),
		('MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS_T2',		'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HOLY_T2_HAS_GOLD_DIST'		),
		('MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS_T3',		'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HOLY_T3_HAS_GOLD_DIST'		),
		('MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS_T1',		'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HOLY_T1_HAS_INDZONE'			),
		('MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS_T2',		'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HOLY_T2_HAS_INDZONE'			),
		('MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS_T3',		'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HOLY_T3_HAS_INDZONE'			),
		('MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS_T1',		'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HOLY_T1_HAS_THEATER'			),
		('MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS_T2',		'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HOLY_T2_HAS_THEATER'			),
		('MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS_T3',		'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HOLY_T3_HAS_THEATER'			),
		('MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS_T1',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HOLY_T1_HAS_CAMPUS'			),
		('MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS_T2',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HOLY_T2_HAS_CAMPUS'			),
		('MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS_T3',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HOLY_T3_HAS_CAMPUS'			),

		('MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS_T1',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HARB_T1_HAS_HOLYSITE'			),
		('MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS_T2',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HARB_T2_HAS_HOLYSITE'			),
		('MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS_T3',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HARB_T3_HAS_HOLYSITE'			),
		('MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS_T1',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HARB_T1_HAS_INDZONE'			),
		('MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS_T2',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HARB_T2_HAS_INDZONE'			),
		('MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS_T3',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HARB_T3_HAS_INDZONE'			),
		('MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS_T1',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HARB_T1_HAS_THEATER'			),
		('MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS_T2',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HARB_T2_HAS_THEATER'			),
		('MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS_T3',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HARB_T3_HAS_THEATER'			),
		('MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS_T1',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HARB_T1_HAS_CAMPUS'			),
		('MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS_T2',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HARB_T2_HAS_CAMPUS'			),
		('MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS_T3',			'DMOD_MNX_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',					0,			1,			'REQSR_MNX_IS_HARB_T3_HAS_CAMPUS'			),
...
VALUES	-- Holy Site and Harbor 2X districts adjacency
		...
		('MOD_MNX_ODIN_FISH_FARMS_COAST',							'ImprovementType',				'IMPROVEMENT_MNX_ODIN_FISH_FARM'					),
		('MOD_MNX_ODIN_FISH_FARMS_COAST',							'TerrainType',					'TERRAIN_COAST'										),
		('MOD_MNX_ODIN_FISH_FARMS_OCEAN',							'ImprovementType',				'IMPROVEMENT_MNX_ODIN_FISH_FARM'					),
		('MOD_MNX_ODIN_FISH_FARMS_OCEAN',							'TerrainType',					'TERRAIN_OCEAN'										),

		-----------------------------------------------
		-- Coastal Cities Housing
		('MOD_MNX_ODIN_COASTAL_CITY_HOUSING',						'Amount',						1													),
		-- Coastal Districts Amenities
		('MOD_MNX_ODIN_COASTAL_DISTRICT_AMENITY',					'Amount',						1													),

		-----------------------------------------------
		-- Cheaper Districts
		('MOD_MNX_ODIN_CHEAP_HOLYSITE_PROD',						'DistrictType',					'DISTRICT_HOLY_SITE'								),
		('MOD_MNX_ODIN_CHEAP_HOLYSITE_PROD',						'Amount',						100													),
		('MOD_MNX_ODIN_CHEAP_HARBOR_PROD',							'DistrictType',					'DISTRICT_HARBOR'									),
		('MOD_MNX_ODIN_CHEAP_HARBOR_PROD',							'Amount',						100													),
		('MOD_MNX_ODIN_CHEAP_ENCAMPMENT_PROD',						'DistrictType',					'DISTRICT_ENCAMPMENT'								),
		('MOD_MNX_ODIN_CHEAP_ENCAMPMENT_PROD',						'Amount',						100													),
		
		/*('MOD_MNX_ODIN_CHEAP_HOLYSITE_BUY',							'Amount',						100													),
		('MOD_MNX_ODIN_CHEAP_HARBOR_BUY',							'Amount',						100													),
		('MOD_MNX_ODIN_CHEAP_ENCAMPMENT_BUY',						'Amount',						100													),
		*/
		-----------------------------------------------
		-- Trade Route from Shrines
		...
		-----------------------------------------------
		-- Science and Culture from Tier 3 HS and HR
		('MOD_MNX_ODIN_WATER_CULT_TIER3_HOLYSITE',					'YieldType',					'YIELD_CULTURE'										),
		('MOD_MNX_ODIN_WATER_CULT_TIER3_HOLYSITE',					'Amount',						1													),
		('MOD_MNX_ODIN_WATER_SCI_TIER3_HOLYSITE',					'YieldType',					'YIELD_SCIENCE'										),
		('MOD_MNX_ODIN_WATER_SCI_TIER3_HOLYSITE',					'Amount',						1													),
		
		('MOD_MNX_ODIN_WATER_CULT_TIER3_HARBOR',					'YieldType',					'YIELD_CULTURE'										),
		('MOD_MNX_ODIN_WATER_CULT_TIER3_HARBOR',					'Amount',						1													),
		('MOD_MNX_ODIN_WATER_SCI_TIER3_HARBOR',						'YieldType',					'YIELD_SCIENCE'										),
		('MOD_MNX_ODIN_WATER_SCI_TIER3_HARBOR',						'Amount',						1													),

		-----------------------------------------------
		/*-- Holy Site and Harbor: Mirror Yields from built districts
		('MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS',				'YieldTypeToGrant',				'YIELD_GOLD'										),
		('MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS',				'YieldTypeToMirror',			'YIELD_FAITH'										),
		('MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS',				'YieldTypeToGrant',				'YIELD_PRODUCTION'									),
		('MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS',				'YieldTypeToMirror',			'YIELD_FAITH'										),
		('MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS',				'YieldTypeToGrant',				'YIELD_CULTURE'										),
		('MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS',				'YieldTypeToMirror',			'YIELD_FAITH'										),
		('MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS',				'YieldTypeToGrant',				'YIELD_SCIENCE'										),
		('MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS',				'YieldTypeToMirror',			'YIELD_FAITH'										),
		
		('MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS',				'YieldTypeToGrant',				'YIELD_FAITH'										),
		('MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS',				'YieldTypeToMirror',			'YIELD_GOLD'										),
		('MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS',					'YieldTypeToGrant',				'YIELD_PRODUCTION'									),
		('MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS',					'YieldTypeToMirror',			'YIELD_GOLD'										),
		('MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS',					'YieldTypeToGrant',				'YIELD_CULTURE'										),
		('MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS',					'YieldTypeToMirror',			'YIELD_GOLD'										),
		('MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS',					'YieldTypeToGrant',				'YIELD_SCIENCE'										),
		('MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS',					'YieldTypeToMirror',			'YIELD_GOLD'										),		
		*/
		-----------------------------------------------
		-- Holy Site and Harbor: Yields from built districts
		('MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS_T1',			'YieldType',					'YIELD_GOLD'										),
		('MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS_T1',			'Amount',						2													),
		('MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS_T2',			'YieldType',					'YIELD_GOLD'										),
		('MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS_T2',			'Amount',						2													),
		('MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS_T3',			'YieldType',					'YIELD_GOLD'										),
		('MOD_MNX_ODIN_HOLYSITE_GOLD_FROM_DISTRICTS_T3',			'Amount',						2													),
		('MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS_T1',			'YieldType',					'YIELD_PRODUCTION'									),
		('MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS_T1',			'Amount',						2													),
		('MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS_T2',			'YieldType',					'YIELD_PRODUCTION'									),
		('MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS_T2',			'Amount',						2													),
		('MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS_T3',			'YieldType',					'YIELD_PRODUCTION'									),
		('MOD_MNX_ODIN_HOLYSITE_PROD_FROM_DISTRICTS_T3',			'Amount',						2													),
		('MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS_T1',			'YieldType',					'YIELD_CULTURE'										),
		('MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS_T1',			'Amount',						2													),
		('MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS_T2',			'YieldType',					'YIELD_CULTURE'										),
		('MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS_T2',			'Amount',						2													),
		('MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS_T3',			'YieldType',					'YIELD_CULTURE'										),
		('MOD_MNX_ODIN_HOLYSITE_CULT_FROM_DISTRICTS_T3',			'Amount',						2													),
		('MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS_T1',				'YieldType',					'YIELD_SCIENCE'										),
		('MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS_T1',				'Amount',						2													),
		('MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS_T2',				'YieldType',					'YIELD_SCIENCE'										),
		('MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS_T2',				'Amount',						2													),
		('MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS_T3',				'YieldType',					'YIELD_SCIENCE'										),
		('MOD_MNX_ODIN_HOLYSITE_SCI_FROM_DISTRICTS_T3',				'Amount',						2													),
		
		('MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS_T1',				'YieldType',					'YIELD_FAITH'										),
		('MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS_T1',				'Amount',						2													),
		('MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS_T2',				'YieldType',					'YIELD_FAITH'										),
		('MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS_T2',				'Amount',						2													),
		('MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS_T3',				'YieldType',					'YIELD_FAITH'										),
		('MOD_MNX_ODIN_HARBOR_FAITH_FROM_DISTRICTS_T3',				'Amount',						2													),
		('MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS_T1',				'YieldType',					'YIELD_PRODUCTION'									),
		('MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS_T1',				'Amount',						2													),
		('MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS_T2',				'YieldType',					'YIELD_PRODUCTION'									),
		('MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS_T2',				'Amount',						2													),
		('MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS_T3',				'YieldType',					'YIELD_PRODUCTION'									),
		('MOD_MNX_ODIN_HARBOR_PROD_FROM_DISTRICTS_T3',				'Amount',						2													),
		('MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS_T1',				'YieldType',					'YIELD_CULTURE'										),
		('MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS_T1',				'Amount',						2													),
		('MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS_T2',				'YieldType',					'YIELD_CULTURE'										),
		('MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS_T2',				'Amount',						2													),
		('MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS_T3',				'YieldType',					'YIELD_CULTURE'										),
		('MOD_MNX_ODIN_HARBOR_CULT_FROM_DISTRICTS_T3',				'Amount',						2													),
		('MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS_T1',				'YieldType',					'YIELD_SCIENCE'										),
		('MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS_T1',				'Amount',						2													),
		('MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS_T2',				'YieldType',					'YIELD_SCIENCE'										),
		('MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS_T2',				'Amount',						2													),
		('MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS_T3',				'YieldType',					'YIELD_SCIENCE'										),
		('MOD_MNX_ODIN_HARBOR_SCI_FROM_DISTRICTS_T3',				'Amount',						2													),
