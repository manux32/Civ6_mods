...
VALUES	('ABILITY_MNX_ALL_MOVEMENT_1',					1,			'(ODIN) +10 [ICON_Movement] Movement to all Units.'),
		...
		('ABILITY_MNX_EMBARK_MOVEMENT_1',				1,			'(ODIN) +1 [ICON_Movement] Embarked Movement (once a Religion is founded).'),
		('ABILITY_MNX_EMBARK_MOVEMENT_2',				1,			NULL),
		('ABILITY_MNX_EMBARK_MOVEMENT_3',				1,			NULL),
		('ABILITY_MNX_EMBARK_MOVEMENT_4',				1,			NULL),

		('ABILITY_MNX_SEA_MOVEMENT_1',					1,			'(ODIN) +1 [ICON_Movement] Movement (once a Religion is founded).'),
		('ABILITY_MNX_SEA_MOVEMENT_2',					1,			NULL),
		('ABILITY_MNX_SEA_MOVEMENT_3',					1,			NULL),
		('ABILITY_MNX_SEA_MOVEMENT_4',					1,			NULL),

		('ABILITY_MNX_COMBAT_STRENGTH',					1,			'(ODIN) +5 [ICON_Strength] Combat Strength (once a Religion is founded).'),
		('ABILITY_MNX_EMBARK_COMBAT',					1,			'(ODIN) +5 [ICON_Strength] Embarked Combat Strength (once a Religion is founded).'),
		
		('ABILITY_MNX_EMBARK_SIGHT',					1,			'(ODIN) +1 Sight Range when Embarked (once a Religion is founded).'),
		('ABILITY_MNX_NAVAL_SIGHT',						1,			'(ODIN) +1 Sight Range (once a Religion is founded).'),

		('ABILITY_MNX_RECON_MOVEMENT',					1,			'(ODIN) +1 [ICON_Movement] Movement.'),
		('ABILITY_MNX_RECON_EMBARK_MOVEMENT',			1,			'(ODIN) +1 [ICON_Movement] Embarked Movement.'),
		('ABILITY_MNX_RECON_COMBAT',					1,			'(ODIN) +10 [ICON_Strength] Combat Strength.'),
		('ABILITY_MNX_RECON_SIGHT',						1,			'(ODIN) +1 Sight Range.'),
		('ABILITY_MNX_RECON_EMBARK_SIGHT',				1,			'(ODIN) +1 Sight Range when Embarked.'),
		('ABILITY_MNX_RECON_ATTACK_RANGE',				1,			'(ODIN) +1 [ICON_Range] Attack Range.'),
		...
		('ABILITY_MNX_HEAL_NEUTRAL_TERRITORY',			1,			'(ODIN) Can heal in neutral territory (once a Religion is founded).'),

		('ABILITY_MNX_SEA_STRENGTH_1',					1,			'(ODIN) +5 [ICON_Strength] Combat Strength (once a Religion is founded).'),
...
VALUES	-------------------------------------------------------------------------------------------------------------------------------------------------
		...
		('MOD_MNX_EMBARK_MOVEMENT_1',					'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'PLAYER_IS_HUMAN',			'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		...
		('MOD_MNX_SEA_MOVEMENT_1',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'PLAYER_IS_HUMAN',			'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		...
		('MOD_MNX_SHIP_HEAL_NEUTRAL',					'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'PLAYER_IS_HUMAN',			'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),

		('MOD_MNX_SEA_STRENGTH_1',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'PLAYER_IS_HUMAN',			'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
...
VALUES	-------------------------------------------------------------------------------------------------------------------------------------------------
		...
		('MOD_MNX_ABIL_RECON_EMBARK_MOVEMENT',			'Amount',					'1'),
		('MOD_MNX_ABIL_RECON_COMBAT',					'Amount',					'10'),
...
VALUES	-- Units Abilities
		...
		--('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',		'MOD_MNX_EMBARK_COMBAT'),

		('TRAIT_LEADER_MNX_THE_GODS_ARE_WITH_US',		'MOD_MNX_EMBARK_SIGHT'),
		('TRAIT_LEADER_MNX_THE_GODS_ARE_WITH_US',		'MOD_MNX_NAVAL_SIGHT'),			

		('TRAIT_LEADER_MNX_THE_GODS_ARE_WITH_US',		'MOD_MNX_SEA_MOVEMENT_1'),
		--('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',		'MOD_MNX_SEA_MOVEMENT_2'),
		...
		--('TRAIT_CIVILIZATION_MNX_SONS_OF_ODIN',		'MOD_MNX_FIGHT_WHILE_EMBARKED'),		
		...
		('TRAIT_LEADER_MNX_THE_GODS_ARE_WITH_US',	'MOD_MNX_SEA_STRENGTH_1'),
