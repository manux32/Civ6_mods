...
VALUES	----------------------------------------------------------------------------------------------------------------------
		...
		('MOD_MNX_SEA_MOVEMENT_1',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		('MOD_MNX_SEA_MOVEMENT_2',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		...
		('MOD_MNX_FIGHT_WHILE_EMBARKED',				'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		('MOD_MNX_SHIP_HEAL_NEUTRAL',					'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),

		('MOD_MNX_CAPTURE_SHIPS',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		
		('MOD_MNX_SEA_STRENGTH_1',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		...
		('MOD_MNX_ABIL_CAPTURE_SHIPS',					'MODIFIER_UNIT_ADJUST_COMBAT_UNIT_CAPTURE',				NULL),
...
VALUES	-------------------------------------------------------------------------------------------------------------------------------------------------
		...
		('MOD_MNX_ABIL_RECON_EMBARK_MOVEMENT',			'Amount',					'1'),	-- Seems like we need to put +1 more to get 2 total. Doesn't stack on top of MOD_MNX_ABIL_RECON_MOVEMENT
