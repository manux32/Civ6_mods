...
VALUES	--('ABILITY_MNX_ALL_MOVEMENT_1',					1,			'(ODIN) +10 [ICON_Movement] Movement to all Units.'),
		...
		('ABILITY_MNX_SEA_MOVEMENT_1',					1,			'(ODIN) +1 [ICON_Movement] Movement (Religion).'),
		...
		('ABILITY_MNX_RECON_COMBAT',					1,			'(ODIN) +10 [ICON_Strength] Combat Strength (Recon).'),
		...
		('ABILITY_MNX_SEA_STRENGTH_1',					1,			'(ODIN) +5 [ICON_Strength] Naval Combat Strength (Religion).'),
...
VALUES	----------------------------------------------------------------------------------------------------------------------
		...
		----------------------------------------------------------------------------------------------------------------------
		--('MOD_MNX_EMBARK_ALL_UNITS',					'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		--('MOD_MNX_UNLOCK_OCEAN',						'MODIFIER_PLAYER_UNITS_ADJUST_VALID_TERRAIN',			NULL),

		--('MOD_MNX_ALL_MOVEMENT_1',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		--('MOD_MNX_LAND_UNITS_MOVEMENT_1',				'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		
		('MOD_MNX_EMBARK_MOVEMENT_1',					'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		--('MOD_MNX_EMBARK_MOVEMENT_2',					'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		--('MOD_MNX_EMBARK_MOVEMENT_3',					'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		--('MOD_MNX_EMBARK_MOVEMENT_4',					'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),

		('MOD_MNX_COMBAT_STRENGTH',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		--('MOD_MNX_EMBARK_COMBAT',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		
		('MOD_MNX_EMBARK_SIGHT',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		('MOD_MNX_NAVAL_SIGHT',							'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),

		('MOD_MNX_SEA_MOVEMENT_1',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		--('MOD_MNX_SEA_MOVEMENT_2',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		--('MOD_MNX_SEA_MOVEMENT_3',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		--('MOD_MNX_SEA_MOVEMENT_4',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),

		('MOD_MNX_RECON_MOVEMENT',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		('MOD_MNX_RECON_EMBARK_MOVEMENT',				'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		('MOD_MNX_RECON_COMBAT',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		('MOD_MNX_RECON_SIGHT',							'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		('MOD_MNX_RECON_EMBARK_SIGHT',					'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		('MOD_MNX_RECON_ATTACK_RANGE',					'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'REQSR_MNX_HAS_TECH_ARCHERY'),
		
		('MOD_MNX_WATER_TRADER_PROTECT',				'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'REQSR_MNX_IS_TRADER_HAS_RELIGION'),
		--('MOD_MNX_IGNORE_EMBARK_DISEMBARK_COST',		'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		--('MOD_MNX_FIGHT_WHILE_EMBARKED',				'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		('MOD_MNX_SHIP_HEAL_NEUTRAL',					'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),

		('MOD_MNX_SEA_STRENGTH_1',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		--('MOD_MNX_SEA_STRENGTH_2',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		--('MOD_MNX_SEA_STRENGTH_3',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		--('MOD_MNX_SEA_STRENGTH_4',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),

		('MOD_MNX_RELIGIOUS_STRENGTH_1',				'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		--('MOD_MNX_RELIGIOUS_STRENGTH_2',				'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					NULL),
		
		------------------------------------------------------------------------------------------------------------------------
		-- Unit Abilities modifiers
		------------------------------------------------------------------------------------------------------------------------
		--('MOD_MNX_ABIL_ALL_MOVEMENT_1',					'MODIFIER_PLAYER_UNIT_ADJUST_MOVEMENT',					NULL),
		--('MOD_MNX_ABIL_LAND_UNITS_MOVEMENT_1',			'MODIFIER_PLAYER_UNIT_ADJUST_MOVEMENT',					NULL),
		
		('MOD_MNX_ABIL_EMBARK_MOVEMENT_1',				'MODIFIER_PLAYER_UNIT_ADJUST_MOVEMENT',					'REQUIREMENTS_UNIT_IS_EMBARKED'),
		--('MOD_MNX_ABIL_EMBARK_MOVEMENT_2',				'MODIFIER_PLAYER_UNIT_ADJUST_MOVEMENT',					'REQUIREMENTS_UNIT_IS_EMBARKED'),
		--('MOD_MNX_ABIL_EMBARK_MOVEMENT_3',				'MODIFIER_PLAYER_UNIT_ADJUST_MOVEMENT',					'REQUIREMENTS_UNIT_IS_EMBARKED'),
		--('MOD_MNX_ABIL_EMBARK_MOVEMENT_4',				'MODIFIER_PLAYER_UNIT_ADJUST_MOVEMENT',					'REQUIREMENTS_UNIT_IS_EMBARKED'),
		
		('MOD_MNX_ABIL_COMBAT_STRENGTH',				'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					NULL),
		--('MOD_MNX_ABIL_EMBARK_COMBAT',					'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					'REQUIREMENTS_UNIT_IS_EMBARKED'),
		
		('MOD_MNX_ABIL_EMBARK_SIGHT',					'MODIFIER_PLAYER_UNIT_ADJUST_SIGHT',					'REQUIREMENTS_UNIT_IS_EMBARKED'),
		('MOD_MNX_ABIL_NAVAL_SIGHT',					'MODIFIER_PLAYER_UNIT_ADJUST_SIGHT',					NULL),

		('MOD_MNX_ABIL_SEA_MOVEMENT_1',					'MODIFIER_PLAYER_UNIT_ADJUST_SEA_MOVEMENT',				NULL),
		--('MOD_MNX_ABIL_SEA_MOVEMENT_2',					'MODIFIER_PLAYER_UNIT_ADJUST_SEA_MOVEMENT',				NULL),
		--('MOD_MNX_ABIL_SEA_MOVEMENT_3',					'MODIFIER_PLAYER_UNIT_ADJUST_SEA_MOVEMENT',				NULL),
		--('MOD_MNX_ABIL_SEA_MOVEMENT_4',					'MODIFIER_PLAYER_UNIT_ADJUST_SEA_MOVEMENT',				NULL),

		('MOD_MNX_ABIL_RECON_MOVEMENT',					'MODIFIER_PLAYER_UNIT_ADJUST_MOVEMENT',					NULL),
		('MOD_MNX_ABIL_RECON_EMBARK_MOVEMENT',			'MODIFIER_PLAYER_UNIT_ADJUST_MOVEMENT',					'REQUIREMENTS_UNIT_IS_EMBARKED'),
		('MOD_MNX_ABIL_RECON_COMBAT',					'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					NULL),
		('MOD_MNX_ABIL_RECON_SIGHT',					'MODIFIER_PLAYER_UNIT_ADJUST_SIGHT',					NULL),
		('MOD_MNX_ABIL_RECON_EMBARK_SIGHT',				'MODIFIER_PLAYER_UNIT_ADJUST_SIGHT',					'REQUIREMENTS_UNIT_IS_EMBARKED'),
		('MOD_MNX_ABIL_RECON_ATTACK_RANGE',				'MODIFIER_UNIT_ADJUST_ATTACK_RANGE',					NULL),
		
		--('MOD_MNX_ABIL_IGNORE_EMBARK_DISEMBARK_COST',	'MODIFIER_PLAYER_UNIT_ADJUST_IGNORE_SHORES',			NULL),
		--('MOD_MNX_ABIL_FIGHT_WHILE_EMBARKED',			'MODIFIER_SINGLE_UNIT_ADJUST_FIGHT_WHILE_EMBARKED',		NULL),
		('MOD_MNX_ABIL_SHIP_HEAL_NEUTRAL',				'MODIFIER_PLAYER_UNIT_ADJUST_HEAL_PER_TURN',			NULL),
		
		('MOD_MNX_ABIL_SEA_STRENGTH_1',					'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					NULL),
		--('MOD_MNX_ABIL_SEA_STRENGTH_2',					'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					NULL),
		--('MOD_MNX_ABIL_SEA_STRENGTH_3',					'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					NULL),
		--('MOD_MNX_ABIL_SEA_STRENGTH_4',					'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					NULL),

		('MOD_MNX_ABIL_RELIGIOUS_STRENGTH_1',			'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					NULL);
		--('MOD_MNX_ABIL_RELIGIOUS_STRENGTH_2',			'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					NULL);
