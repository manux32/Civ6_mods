...
INSERT INTO	Types
		(Type,												Kind			)
VALUES	('TRAIT_LEADER_MNX_EXPLORE_AND_CONQUER',			'KIND_TRAIT'	),
		('TRAIT_LEADER_MNX_THE_GODS_ARE_WITH_US',			'KIND_TRAIT'	),
		('TRAIT_LEADER_MNX_NORSE_ADVENTURER',				'KIND_TRAIT'	),
		('ABILITY_MNX_BUILDER_SETTLER_IGNORE_TERRAIN_COST',	'KIND_ABILITY'	);
...
INSERT INTO Tags
		(Tag,							Vocabulary		)
VALUES	('CLASS_MNX_IGNORE_TERRAIN_COST',	'ABILITY_CLASS'	);
...
INSERT INTO TypeTags
		(Type,												Tag								)
VALUES	('UNIT_BUILDER',									'CLASS_MNX_IGNORE_TERRAIN_COST'		),
		('UNIT_SETTLER',									'CLASS_MNX_IGNORE_TERRAIN_COST'		),
		('ABILITY_MNX_BUILDER_SETTLER_IGNORE_TERRAIN_COST',	'CLASS_MNX_IGNORE_TERRAIN_COST'		);
...
VALUES	('ABILITY_MNX_BUILDER_SETTLER_IGNORE_TERRAIN_COST',	'LOC_ABILITY_MNX_BUILDER_SETTLER_IGNORE_TERRAIN_COST_NAME',	'LOC_ABILITY_MNX_BUILDER_SETTLER_IGNORE_TERRAIN_COST_DESCRIPTION',		1			);
...
VALUES	('ABILITY_MNX_BUILDER_SETTLER_IGNORE_TERRAIN_COST',		'ALTITUDE_TRAINING_IGNORE_HILLS'	);
...
VALUES	('TRAIT_LEADER_MNX_EXPLORE_AND_CONQUER',	'LOC_TRAIT_LEADER_MNX_EXPLORE_AND_CONQUER_NAME',	'LOC_TRAIT_LEADER_MNX_EXPLORE_AND_CONQUER_DESCRIPTION'	),
		('TRAIT_LEADER_MNX_THE_GODS_ARE_WITH_US',	'LOC_TRAIT_LEADER_MNX_THE_GODS_ARE_WITH_US_NAME',	'LOC_TRAIT_LEADER_MNX_THE_GODS_ARE_WITH_US_DESCRIPTION'	),
		('TRAIT_LEADER_MNX_NORSE_ADVENTURER',		'LOC_UNIT_MNX_NORSE_ADVENTURER_NAME',				'LOC_UNIT_MNX_NORSE_ADVENTURER_DESCRIPTION'	);
...
VALUES	('LEADER_MNX_NORSE',	'TRAIT_LEADER_MNX_EXPLORE_AND_CONQUER'	),
		('LEADER_MNX_NORSE',	'TRAIT_LEADER_MNX_THE_GODS_ARE_WITH_US'	),
