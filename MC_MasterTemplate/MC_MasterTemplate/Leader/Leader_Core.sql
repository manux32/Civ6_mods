...
INSERT INTO	Types
			(Type,					Kind			)
VALUES		('LEADER_MNX_NORSE',	'KIND_LEADER'	);
...
VALUES		('LEADER_MNX_NORSE',	'LOC_LEADER_MNX_NORSE_NAME',	'LEADER_DEFAULT', 	4				);
...
VALUES		('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		'LOC_CITY_NAME_NIDAROS'	);
...
INSERT INTO	LeaderQuotes
			(LeaderType,			Quote										)
VALUES		('LEADER_MNX_NORSE',	'LOC_PEDIA_LEADERS_PAGE_MC_PO_NGBE_QUOTE'	);
...
VALUES		('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_1'		),
			('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_2'		),
			('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_3'		),
			('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_4'		),
			('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_5'		),
			('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_6'		),
			('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_7'		),
			('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_8'		),
			('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_9'		),
			('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_10'		),
			('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_11'		),
			('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_12'		),
			('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_13'		),
			('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_14'		),
			('CIVILIZATION_MNX_NORSE',		'LEADER_MNX_NORSE',		-1,			'LOC_CITY_NAME_MC_OLMEC_15'		);*/
