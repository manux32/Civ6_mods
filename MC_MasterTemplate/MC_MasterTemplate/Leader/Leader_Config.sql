...
VALUES	/*(	
		...
		'LOC_TRAIT_LEADER_MNX_NORSE_MAIN_NAME', -- LeaderAbilityName
		'LOC_TRAIT_LEADER_MNX_NORSE_MAIN_DESCRIPTION', -- LeaderAbilityDescription
		'ICON_LEADER_MNX_NORSE' -- LeaderAbilityIcon
		);
...
VALUES	(
		...
		'CIVILIZATION_MNX_NORSE', -- CivilizationType
		'LEADER_MNX_NORSE', -- LeaderType
		'IMPROVEMENT_MNX_ODIN_FISH_FARM', -- Type
		'ICON_IMPROVEMENT_MNX_ODIN_FISH_FARM', -- Icon
		'LOC_IMPROVEMENT_MNX_ODIN_FISH_FARM_NAME', -- Name
		'LOC_IMPROVEMENT_MNX_ODIN_FISH_FARM_DESCRIPTION', -- Description
		--20 -- SortIndex
		60 -- SortIndex
		);
