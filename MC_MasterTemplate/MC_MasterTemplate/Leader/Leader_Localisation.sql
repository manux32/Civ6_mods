...
-----------------------------------------------	
	...
	'A [ICON_Strength] stronger version of the Scout with a [ICON_Range] ranged attack.'),
	...
	' ---------- Once a RELIGION is founded: ---------- [NEWLINE]Get +1 Wildcard policy slot. +1 [ICON_FOOD] Food on water tiles. All Naval Units can heal in neutral territory. All combat units receive +5 [ICON_Strength] Combat Strength (including Religious combat). Naval and embarked units get +1 Sight and +1 [ICON_Movement] Movement. Land combat units can fight while embarked. Civilian and Recon units, and Buildings in City Center, Harbor, Encampment, and Holy Site, can be purchased with [ICON_Faith] Faith. Cities with a Governor and a Tier 2 Harbor building can purchase Districts with [ICON_GOLD] Gold. Cities with a Tier 3 Holy Site building can purchase Naval Units (Harbor Tier 1 building built), Land Combat units (Encampment built), Air units, and Districts (Governor present) with [ICON_Faith] Faith.'),
	...
	('en_US',	'LOC_ABILITY_MC_BUILDER_SETTLER_IGNORE_TERRAIN_COST_DESCRIPTION',	'Settlers and Builders ignore movement penalties on Hills.'),
