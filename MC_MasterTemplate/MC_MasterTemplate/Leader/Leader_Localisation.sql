...
-----------------------------------------------	
	...
	'Get the Norse Adventurer, a [ICON_Strength] stronger version of the scout with a [ICON_Range] ranged attack. All recon units get +10 [ICON_Strength] Combat Strength, +1 [ICON_Movement] Movement, +1 Sight, and +1 [ICON_Range] Attack Range once Archery is researched. Settlers and Builders ignore movement penalties in Hills terrain.[NEWLINE] -------- We will prevail, The Gods are with us! -------- [NEWLINE]Get +2 [ICON_GreatProphet] Great Prophet, +2 [ICON_GreatAdmiral] Great Admiral, +2 [ICON_GreatGeneral] Great General, +2 [ICON_GreatMerchant] Great Merchant points per turn.[NEWLINE] -------- Once a RELIGION is founded: -------- [NEWLINE]Get +1 Wildcard policy slot. Naval Units can be purchased with [ICON_Faith] Faith. Buildings in City Center, Harbor, Encampment, and Holy Site can be purchased with [ICON_Faith] Faith. Cities with a Governor can purchase Districts with [ICON_Faith] Faith or [ICON_GOLD] Gold. All combat units receive +5 [ICON_Strength] Combat Strength (including Religious combat). Naval and embarked units get +1 Sight and +1 [ICON_Movement] Movement.[NEWLINE] -------- HARADA TRAIT -------- [NEWLINE]Allows coastal raiding for all naval melee units and +50% [ICON_PRODUCTION] Production toward all naval melee units. Receive [ICON_SCIENCE] Science from pillaging and coastal raiding Mines in addition to [ICON_GOLD] Gold. Pillaging or coastal raiding Quarries, Pastures, Plantations, and Camps provide [ICON_CULTURE] Culture in addition to [ICON_FAITH] Faith. Gain the Viking Longship unique unit with Sailing.'	),
