...
-----------------------------------------------	
	...
	'+30% [ICON_PRODUCTION] Production towards Naval units. All Naval units get +1 [ICON_Movement] Movement, +5 [ICON_Strength] Combat Strength, and a chance to capture defeated enemy Naval units. Naval Melee units heal in neutral territory and can perform coastal raiding. Pillaging or coastal raiding Mines provides [ICON_GOLD] Gold and [ICON_SCIENCE] Science, while Quarries, Pastures, Plantations, and Camps provide [ICON_FAITH] Faith and [ICON_CULTURE] Culture.[NEWLINE] -------------------- [NEWLINE]All Recon units get +5 [ICON_Strength] Combat Strength, +1 Sight, +1 [ICON_Movement] Movement, +1 [ICON_Movement] embarked Movement, and +1 [ICON_Range] Attack Range (with Archery). Settlers, Builders and Recon units ignore movement penalties on Hills.[NEWLINE] ---------- Once a RELIGION is founded: ---------- [NEWLINE]+1 Wildcard policy slot. Apostles can chose from any promotion. +1 [ICON_FOOD] Food on water tiles. All Naval Units can heal in neutral territory. All units receive +5 [ICON_Strength] Combat Strength (including Religious). Naval and embarked units get +1 Sight and +1 [ICON_Movement] Movement. Land combat units can fight while embarked. Civilian and Recon units, and Buildings in City Center, Harbor, Encampment, and Holy Site, can be purchased with [ICON_Faith] Faith. Cities with a Governor and a Tier 2 Harbor building can purchase Districts with [ICON_GOLD] Gold. Cities with a Tier 3 Holy Site building can purchase the following with [ICON_Faith] Faith: Naval Units (Harbor Tier 1 building), Land Combat units (Encampment), Air units (Airport), and Districts (Governor).'),
	...
	-- Norse Adventurer
	('en_US',	'LOC_UNIT_MNX_NORSE_ADVENTURER_NAME',						'Norse Adventurer'	),
	('en_US',	'LOC_UNIT_MNX_NORSE_ADVENTURER_DESCRIPTION',
	'A [ICON_Strength] stronger version of the Scout with a [ICON_Range] ranged attack and a companion dog.'),
	...
	' ---------- Once a RELIGION is founded: ---------- [NEWLINE]+1 Wildcard policy slot. Apostles can chose from any promotion. +1 [ICON_FOOD] Food on water tiles. All Naval Units can heal in neutral territory. All units receive +5 [ICON_Strength] Combat Strength (including Religious). Naval and embarked units get +1 Sight and +1 [ICON_Movement] Movement. Land combat units can fight while embarked. Civilian and Recon units, and Buildings in City Center, Harbor, Encampment, and Holy Site, can be purchased with [ICON_Faith] Faith. Cities with a Governor and a Tier 2 Harbor building can purchase Districts with [ICON_GOLD] Gold. Cities with a Tier 3 Holy Site building can purchase the following with [ICON_Faith] Faith: Naval Units (Harbor Tier 1 building), Land Combat units (Encampment), Air units (Airport), and Districts (Governor).'),
	...
	('en_US',	'LOC_ABILITY_MNX_BUILDER_SETTLER_IGNORE_TERRAIN_COST_NAME',			'Heights dont scare us!'	),
	('en_US',	'LOC_ABILITY_MNX_BUILDER_SETTLER_IGNORE_TERRAIN_COST_DESCRIPTION',	'Settlers and Builders ignore movement penalties on Hills.'),
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_KUDO_LEADER_MNX_NORSE_REASON_ANY',	'(You have a high culture output and are progressing well with science.)'	),
	...
	('en_US',	'LOC_DIPLO_WARNING_LEADER_MNX_NORSE_REASON_ANY',	'(You have a low level of faith.)'	),
...
-----------------------------------------------	
	...
	('en_US',	'LOC_LOADING_INFO_LEADER_MNX_NORSE',
	...
	'Fearsome explorer and conquerer of the unknown. Your Viking ships will bring you to distant lands, and your Norse Adventurer will help find the best places to expand your realm, quicker than anyone. Your Beserkers will help keep those new lands safe, and new neighbors will fear you. The Gods are with you, Erik!'),
...
-----------------------------------------------	
	...
	-- First AI Line (ANY)
	('en_US',	'LOC_DIPLO_FIRST_MEET_LEADER_MNX_NORSE_ANY',
	...
	('en_US',	'LOC_DIPLO_FIRST_MEET_VISIT_RECIPIENT_LEADER_MNX_NORSE_ANY',
	...
	('en_US',	'LOC_DIPLO_FIRST_MEET_NEAR_INITIATOR_POSITIVE_LEADER_MNX_NORSE_ANY',
	'I am glad to hear it.'	),
	
	-- AI invitation to exchange Capital Information (ANY)
	('en_US',	'LOC_DIPLO_FIRST_MEET_NO_MANS_INFO_EXCHANGE_LEADER_MNX_NORSE_ANY',
...
-----------------------------------------------	
	...
	-- AI Accepts (ANY)
	('en_US',	'LOC_DIPLO_ACCEPT_DELEGATION_FROM_HUMAN_LEADER_MNX_NORSE_ANY',
	...
	-- AI Rejects (ANY)
	('en_US',	'LOC_DIPLO_REJECT_DELEGATION_FROM_HUMAN_LEADER_MNX_NORSE_ANY',
	'Our sacred lands are closed to visitors at this time.'	),
	
	-- AI Requests (ANY)
	('en_US',	'LOC_DIPLO_DELEGATION_FROM_AI_LEADER_MNX_NORSE_ANY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_ACCEPT_OPEN_BORDERS_FROM_HUMAN_LEADER_MNX_NORSE_ANY',
	'The lands are under the watch of the Gods - there is no reason we cannot each use them.'	),
	
	-- AI rejects from human (ANY)	
	('en_US',	'LOC_DIPLO_REJECT_OPEN_BORDERS_FROM_HUMAN_LEADER_MNX_NORSE_ANY',
	'Our people have a sacred bond with our lands. To open them to your people would be sacrilege.'	),
	
	-- AI requests from human (ANY)	
	('en_US',	'LOC_DIPLO_OPEN_BORDERS_FROM_AI_LEADER_MNX_NORSE_ANY',
...
-----------------------------------------------	
	...
	-- AI accepts from human (ANY)
	('en_US',	'LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_HUMAN_LEADER_MNX_NORSE_ANY',
	...
	-- AI rejects from human (ANY)	
	('en_US',	'LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_HUMAN_LEADER_MNX_NORSE_ANY',
	'Amo ipan inin kauitl. Our people are not ready to share such a close bond and friendship at this time.'	),
	
	-- AI Requests friendship from human (ANY)	
	('en_US',	'LOC_DIPLO_DECLARE_FRIEND_FROM_AI_LEADER_MNX_NORSE_ANY',
	...
	('en_US',	'LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_AI_LEADER_MNX_NORSE_ANY',
	'With the Olmec gods as our witness: tlazohcamati. May this bond stay unbroken for many lifetimes.'	),
	
	-- Human rejects AI requests, AI responds (ANY)	
	('en_US',	'LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_AI_LEADER_MNX_NORSE_ANY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_MAKE_ALLIANCE_FROM_AI_LEADER_MNX_NORSE_ANY',
...
-----------------------------------------------	
	...
	-- AI Kudos (ANY)
	('en_US',	'LOC_DIPLO_KUDO_EXIT_LEADER_MNX_NORSE_ANY',
	...
	-- AI Warnings (ANY)
	('en_US',	'LOC_DIPLO_WARNING_EXIT_LEADER_MNX_NORSE_ANY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_LEADER_MNX_NORSE_HAPPY',
	...
	('en_US',	'LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_LEADER_MNX_NORSE_UNHAPPY',
	...
	('en_US',	'LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_MNX_NORSE_HAPPY',
	...
	('en_US',	'LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_MNX_NORSE_UNHAPPY',
	...
	('en_US',	'LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_MNX_NORSE_ANY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_MNX_NORSE_HAPPY',
	'The land you have claimed is that of the Olmec. Please be mindful of where you locate your settlements in future.'	),
	
	-- AI warns player for settling too close (UNHAPPY)
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_MNX_NORSE_UNHAPPY',
	...
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_MNX_NORSE_HAPPY',
	...
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_MNX_NORSE_UNHAPPY',
	...
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_MNX_NORSE_HAPPY',
	'There is no need for hostility, we are able to peacefully share these lands. It is the Olmec way!'	),
	
	-- Negative AI response to human request (UNHAPPY)
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_MNX_NORSE_UNHAPPY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_MNX_NORSE_HAPPY',
	'Tlazohcamati! We are in agreement!'	),
	
	-- AI Accepts Deal (Unhappy)
	('en_US',	'LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_MNX_NORSE_UNHAPPY',
	'Kuali ikimeh. Though we see that this bargain provides more benefit to your people than our tlakah.'	),

	-- AI Rejects Deal (HAPPY)
	('en_US',	'LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_MNX_NORSE_HAPPY',
	'Nimitztlatlauhtia. We must find a trade with mutual benefit.'	),
	
	-- AI Rejects Deal (Unhappy)
	('en_US',	'LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_MNX_NORSE_UNHAPPY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_DENOUNCE_FROM_HUMAN_LEADER_MNX_NORSE_ANY',
	'To declare yourself an enemy of the Olmec is to leave your fate to the Gods.'	),
	
	-- From AI
	('en_US',	'LOC_DIPLO_DENOUNCE_FROM_AI_LEADER_MNX_NORSE_ANY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_DECLARE_WAR_FROM_HUMAN_LEADER_MNX_NORSE_ANY',
	'Our lands are protected by our Gods. Your decision will lead you to your tomb.'	),
	
	-- AI Declares War
	('en_US',	'LOC_DIPLO_DECLARE_WAR_FROM_AI_LEADER_MNX_NORSE_ANY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_MAKE_PEACE_AI_ACCEPT_DEAL_LEADER_MNX_NORSE_ANY',
	'Tlauel yektli. Let our people return to a peaceful existence.'	),
	
	-- AI refuses human
	('en_US',	'LOC_DIPLO_MAKE_PEACE_AI_REFUSE_DEAL_LEADER_MNX_NORSE_ANY',
	'The land on which you settle is ours by right and it will be ours by might!'	),
	
	-- AI requests from human
	('en_US',	'LOC_DIPLO_MAKE_PEACE_FROM_AI_LEADER_MNX_NORSE_ANY',
...
-----------------------------------------------	
	...
	-- AI is Defeated
	('en_US',	'LOC_DIPLO_DEFEAT_FROM_AI_LEADER_MNX_NORSE_ANY',
	'Your fate is not cemented by this victory. The Olmec Gods will take their sacrifice in time!'	),

	-- Human is Defeated (will see this in hotseat)
	('en_US',	'LOC_DIPLO_DEFEAT_FROM_HUMAN_LEADER_MNX_NORSE_ANY',
	'{LOC_DIPLO_DEFEAT_FROM_AI_LEADER_MNX_NORSE_ANY}'	),
...
--------------------------------------------------------------------
	...
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_LEADER_MNX_NORSE_CHAPTER_CAPSULE_BODY',
	...
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_LEADER_MNX_NORSE_CHAPTER_DETAILED_BODY',
	...
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_LEADER_MNX_NORSE_CHAPTER_HISTORY_PARA_1',
	...
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_LEADER_MNX_NORSE_CHAPTER_HISTORY_PARA_2',
	...
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_LEADER_MNX_NORSE_CHAPTER_HISTORY_PARA_3',
	...
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_LEADER_MNX_NORSE_CHAPTER_HISTORY_PARA_4',
	...
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_LEADER_MNX_NORSE_CHAPTER_HISTORY_PARA_5',
