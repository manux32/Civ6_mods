...
-----------------------------------------------	
	...
	' ---------- Once a RELIGION is founded: ---------- [NEWLINE]+1 Wildcard policy slot. Apostles can chose from any promotion. +1 [ICON_FOOD] Food on water tiles. All Naval Units can heal in neutral territory. All combat units receive +5 [ICON_Strength] Combat Strength (including Religious combat). Naval and embarked units get +1 Sight and +1 [ICON_Movement] Movement. Land combat units can fight while embarked. Civilian and Recon units, and Buildings in City Center, Harbor, Encampment, and Holy Site, can be purchased with [ICON_Faith] Faith. Cities with a Governor and a Tier 2 Harbor building can purchase Districts with [ICON_GOLD] Gold. Cities with a Tier 3 Holy Site building can purchase the following with [ICON_Faith] Faith: Naval Units (Harbor Tier 1 building), Land Combat units (Encampment), Air units (Airport), and Districts (Governor present).'),
