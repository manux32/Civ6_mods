...
VALUES	('REQSR_MNX_PLOT_HAS_WATER',					'REQUIREMENTSET_TEST_ANY'),
		...
		('REQSR_MNX_DIST_ADJ_HOLY_TIER1_BUILDING',		'REQUIREMENTSET_TEST_ALL'),
...
VALUES	('REQSR_MNX_UNIT_IS_RELIGIOUS',					'REQ_MNX_UNIT_IS_MISSIONARY'),
		...
		('REQSR_MNX_DIST_ADJ_HOLY_TIER1_BUILDING',		'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),
		('REQSR_MNX_DIST_ADJ_HOLY_TIER1_BUILDING',		'REQ_MNX_CITY_HAS_TIER1_HOLY_BUILDING'),
		--('REQSR_MNX_DIST_ADJ_HOLY_TIER1_BUILDING',		'REQ_MNX_PLOT_HAS_ANY_DISTRICT'),
