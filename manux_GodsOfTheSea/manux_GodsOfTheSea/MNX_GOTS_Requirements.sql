...
VALUES	--('REQSR_MNX_UNIT_IS_RELIGIOUS',					'REQ_MNX_UNIT_IS_MISSIONARY'),
		...
		/*('REQSR_MNX_HOLYSITE_ADJ_HOLYSITE',				'REQ_MNX_PLOT_HAS_HOLYSITE'),
		('REQSR_MNX_HOLYSITE_ADJ_HOLYSITE',				'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),
		('REQSR_MNX_HARBOR_ADJ_HOLYSITE',				'REQ_MNX_PLOT_HAS_HARBOR'),
		('REQSR_MNX_HARBOR_ADJ_HOLYSITE',				'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),
		('REQSR_MNX_COMHUB_ADJ_HOLYSITE',				'REQ_MNX_PLOT_HAS_COMHUB'),
		('REQSR_MNX_COMHUB_ADJ_HOLYSITE',				'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),
		('REQSR_MNX_CAMPUS_ADJ_HOLYSITE',				'REQ_MNX_PLOT_HAS_CAMPUS'),
		('REQSR_MNX_CAMPUS_ADJ_HOLYSITE',				'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),
		('REQSR_MNX_THEATER_ADJ_HOLYSITE',				'REQ_MNX_PLOT_HAS_THEATER'),
		('REQSR_MNX_THEATER_ADJ_HOLYSITE',				'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),
		('REQSR_MNX_INDZONE_ADJ_HOLYSITE',				'REQ_MNX_PLOT_HAS_INDZONE'),
		('REQSR_MNX_INDZONE_ADJ_HOLYSITE',				'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),
		('REQSR_MNX_WATERFRONT_ADJ_HOLYSITE',			'REQ_MNX_PLOT_HAS_WATERFRONT'),
		('REQSR_MNX_WATERFRONT_ADJ_HOLYSITE',			'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),

		('REQSR_MNX_HOLYSITE_ADJ_HARBOR',				'REQ_MNX_PLOT_HAS_HOLYSITE'),
		('REQSR_MNX_HOLYSITE_ADJ_HARBOR',				'REQ_MNX_PLOT_ADJ_TO_HARBOR'),
		('REQSR_MNX_HARBOR_ADJ_HARBOR',					'REQ_MNX_PLOT_HAS_HARBOR'),
		('REQSR_MNX_HARBOR_ADJ_HARBOR',					'REQ_MNX_PLOT_ADJ_TO_HARBOR'),
		('REQSR_MNX_COMHUB_ADJ_HARBOR',					'REQ_MNX_PLOT_HAS_COMHUB'),
		('REQSR_MNX_COMHUB_ADJ_HARBOR',					'REQ_MNX_PLOT_ADJ_TO_HARBOR'),
		('REQSR_MNX_CAMPUS_ADJ_HARBOR',					'REQ_MNX_PLOT_HAS_CAMPUS'),
		('REQSR_MNX_CAMPUS_ADJ_HARBOR',					'REQ_MNX_PLOT_ADJ_TO_HARBOR'),
		('REQSR_MNX_THEATER_ADJ_HARBOR',				'REQ_MNX_PLOT_HAS_THEATER'),
		('REQSR_MNX_THEATER_ADJ_HARBOR',				'REQ_MNX_PLOT_ADJ_TO_HARBOR'),
		('REQSR_MNX_INDZONE_ADJ_HARBOR',				'REQ_MNX_PLOT_HAS_INDZONE'),
		('REQSR_MNX_INDZONE_ADJ_HARBOR',				'REQ_MNX_PLOT_ADJ_TO_HARBOR'),
		('REQSR_MNX_WATERFRONT_ADJ_HARBOR',				'REQ_MNX_PLOT_HAS_WATERFRONT'),
		('REQSR_MNX_WATERFRONT_ADJ_HARBOR',				'REQ_MNX_PLOT_ADJ_TO_HARBOR'),*/

		/*('REQSR_MNX_HOLYSITE_ADJ_HOLYSITE',				'REQUIRES_DISTRICT_IS_HOLY_SITE'),
		('REQSR_MNX_HOLYSITE_ADJ_HOLYSITE',				'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),
		('REQSR_MNX_HARBOR_ADJ_HOLYSITE',				'REQUIRES_DISTRICT_IS_HARBOR'),
		('REQSR_MNX_HARBOR_ADJ_HOLYSITE',				'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),
		('REQSR_MNX_COMHUB_ADJ_HOLYSITE',				'REQUIRES_DISTRICT_IS_COMMERCIAL_HUB'),
		('REQSR_MNX_COMHUB_ADJ_HOLYSITE',				'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),
		('REQSR_MNX_CAMPUS_ADJ_HOLYSITE',				'REQUIRES_DISTRICT_IS_CAMPUS'),
		('REQSR_MNX_CAMPUS_ADJ_HOLYSITE',				'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),
		('REQSR_MNX_THEATER_ADJ_HOLYSITE',				'REQUIRES_DISTRICT_IS_THEATER'),
		('REQSR_MNX_THEATER_ADJ_HOLYSITE',				'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),
		('REQSR_MNX_INDZONE_ADJ_HOLYSITE',				'REQUIRES_DISTRICT_IS_INDUSTRIAL_ZONE'),
		('REQSR_MNX_INDZONE_ADJ_HOLYSITE',				'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),
		('REQSR_MNX_WATERFRONT_ADJ_HOLYSITE',			'REQ_MNX_DISTRICT_IS_WATERFRONT'),
		('REQSR_MNX_WATERFRONT_ADJ_HOLYSITE',			'REQ_MNX_PLOT_ADJ_TO_HOLYSITE'),

		('REQSR_MNX_HOLYSITE_ADJ_HARBOR',				'REQUIRES_DISTRICT_IS_HOLY_SITE'),
		('REQSR_MNX_HOLYSITE_ADJ_HARBOR',				'REQ_MNX_PLOT_ADJ_TO_HARBOR'),
		('REQSR_MNX_HARBOR_ADJ_HARBOR',					'REQUIRES_DISTRICT_IS_HARBOR'),
		('REQSR_MNX_HARBOR_ADJ_HARBOR',					'REQ_MNX_PLOT_ADJ_TO_HARBOR'),
		('REQSR_MNX_COMHUB_ADJ_HARBOR',					'REQUIRES_DISTRICT_IS_COMMERCIAL_HUB'),
		('REQSR_MNX_COMHUB_ADJ_HARBOR',					'REQ_MNX_PLOT_ADJ_TO_HARBOR'),
		('REQSR_MNX_CAMPUS_ADJ_HARBOR',					'REQUIRES_DISTRICT_IS_CAMPUS'),
		('REQSR_MNX_CAMPUS_ADJ_HARBOR',					'REQ_MNX_PLOT_ADJ_TO_HARBOR'),
		('REQSR_MNX_THEATER_ADJ_HARBOR',				'REQUIRES_DISTRICT_IS_THEATER'),
		('REQSR_MNX_THEATER_ADJ_HARBOR',				'REQ_MNX_PLOT_ADJ_TO_HARBOR'),
		('REQSR_MNX_INDZONE_ADJ_HARBOR',				'REQUIRES_DISTRICT_IS_INDUSTRIAL_ZONE'),
		('REQSR_MNX_INDZONE_ADJ_HARBOR',				'REQ_MNX_PLOT_ADJ_TO_HARBOR'),
		('REQSR_MNX_WATERFRONT_ADJ_HARBOR',				'REQ_MNX_DISTRICT_IS_WATERFRONT'),
		('REQSR_MNX_WATERFRONT_ADJ_HARBOR',				'REQ_MNX_PLOT_ADJ_TO_HARBOR'),*/
		---------------------------------------------------------------------------------------
