...
VALUES	-- Holy Site and Harbor 2x adjacency
		...
		--('MOD_MNX_PLOT_FAITH_FROM_ADJ_HOLYSITE_L1',	'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',									'PLAYER_IS_HUMAN',			'REQSR_MNX_PLOT_HAS_ADJ_HOLYSITE'),
		...
		('MOD_MNX_PLOT_GOLD_FROM_ADJ_HARBOR_L1',	'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',									'PLAYER_IS_HUMAN',			'REQSR_MNX_PLOT_HAS_ADJ_HARBOR'),
		-- Districts yields from adjacent Holy Site or Harbor
		--('MOD_MNX_DIST_FAITH_FROM_ADJ_HOLYSITE_L1',	'MODIFIER_PLAYER_DISTRICT_ADJUST_BASE_YIELD_CHANGE',					'PLAYER_IS_HUMAN',			'REQSR_MNX_DISTRICT_ADJ_TO_HOLYSITE'),
		...
		('MOD_MNX_DIST_GOLD_FROM_ADJ_HARBOR_L1',	'MODIFIER_PLAYER_DISTRICT_ADJUST_BASE_YIELD_CHANGE',					'PLAYER_IS_HUMAN',			'REQSR_MNX_DISTRICT_ADJ_TO_HARBOR'),
