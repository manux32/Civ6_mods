...
VALUES	('ABILITY_MNX_ALL_MOVEMENT_1',					1,			'(GOTS) +10 [ICON_Movement] Movement to all Units.'),
		...
		('ABILITY_MNX_COMBAT_STRENGTH',					1,			'(GOTS) +5 [ICON_Strength] Combat Strength (once a Religion is founded).'),
		('ABILITY_MNX_EMBARK_COMBAT',					1,			'(GOTS) +5 [ICON_Strength] Embarked Combat Strength (once a Religion is founded).'),
		
		('ABILITY_MNX_EMBARK_SIGHT',					1,			'(GOTS) +2 Sight Range when Embarked (once a Religion is founded).'),
		('ABILITY_MNX_NAVAL_SIGHT',						1,			'(GOTS) +3 Sight Range (once a Religion is founded).'),
		...
		('ABILITY_MNX_RECON_SIGHT',						1,			'(GOTS) +2 Sight Range.'),
		('ABILITY_MNX_RECON_EMBARK_SIGHT',				1,			'(GOTS) +2 Sight Range when Embarked.'),
		('ABILITY_MNX_RECON_ATTACK_RANGE',				1,			'(GOTS) +1 [ICON_Range] Attack Range.'),
		...
		('ABILITY_MNX_RELIGIOUS_STRENGTH_1',			1,			'(GOTS) +5 [ICON_Religion] Religious Strength in Theological Combat for each of the first 2 GOTS levels. (+10 Total)'),
...
VALUES	('ABILITY_MNX_COMBAT_STRENGTH',						'CLASS_ALL_COMBAT_UNITS'),
		...
		('ABILITY_MNX_EMBARK_COMBAT',						'CLASS_LANDCIVILIAN'),
...
VALUES	-- Unlock Unique Units
		('MOD_MNX_UNIQUE_UNIT_DROMON',					'MODIFIER_PLAYER_ADJUST_VALID_UNIT_BUILD',				'PLAYER_IS_HUMAN',			'REQSR_MNX_HAS_TECH_SHIPBLD_AND_REL'),
		('MOD_MNX_UNIQUE_UNIT_SEADOG',					'MODIFIER_PLAYER_ADJUST_VALID_UNIT_BUILD',				'PLAYER_IS_HUMAN',			'REQSR_MNX_HAS_CIVIC_MERCANT_AND_REL'),
		('MOD_MNX_UNIQUE_UNIT_UBOAT',					'MODIFIER_PLAYER_ADJUST_VALID_UNIT_BUILD',				'PLAYER_IS_HUMAN',			'REQSR_MNX_HAS_TECH_ELEC_AND_REL'),
		...
		('MOD_MNX_COMBAT_STRENGTH',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'PLAYER_IS_HUMAN',			'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		('MOD_MNX_EMBARK_COMBAT',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'PLAYER_IS_HUMAN',			'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		
		('MOD_MNX_EMBARK_SIGHT',						'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'PLAYER_IS_HUMAN',			'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		('MOD_MNX_NAVAL_SIGHT',							'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'PLAYER_IS_HUMAN',			'REQSR_MNX_PLAYER_HAS_FOUNDED_RELIGION'),
		...
		('MOD_MNX_RECON_EMBARK_SIGHT',					'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'PLAYER_IS_HUMAN',			NULL),
		('MOD_MNX_RECON_ATTACK_RANGE',					'MODIFIER_PLAYER_UNITS_GRANT_ABILITY',					'PLAYER_IS_HUMAN',			NULL),
		...
		('MOD_MNX_ABIL_COMBAT_STRENGTH',				'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					'PLAYER_IS_HUMAN',			NULL),
		('MOD_MNX_ABIL_EMBARK_COMBAT',					'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					'PLAYER_IS_HUMAN',			'REQUIREMENTS_UNIT_IS_EMBARKED'),
		
		('MOD_MNX_ABIL_EMBARK_SIGHT',					'MODIFIER_PLAYER_UNIT_ADJUST_SIGHT',					'PLAYER_IS_HUMAN',			'REQUIREMENTS_UNIT_IS_EMBARKED'),
		('MOD_MNX_ABIL_NAVAL_SIGHT',					'MODIFIER_PLAYER_UNIT_ADJUST_SIGHT',					'PLAYER_IS_HUMAN',			NULL),
		...
		('MOD_MNX_ABIL_RECON_SIGHT',					'MODIFIER_PLAYER_UNIT_ADJUST_SIGHT',					'PLAYER_IS_HUMAN',			NULL),
		('MOD_MNX_ABIL_RECON_EMBARK_SIGHT',				'MODIFIER_PLAYER_UNIT_ADJUST_SIGHT',					'PLAYER_IS_HUMAN',			'REQUIREMENTS_UNIT_IS_EMBARKED'),
		('MOD_MNX_ABIL_RECON_ATTACK_RANGE',				'MODIFIER_UNIT_ADJUST_ATTACK_RANGE',					'PLAYER_IS_HUMAN',			NULL),
...
VALUES	-- Unique Units
		...
		('MOD_MNX_ABIL_EMBARK_COMBAT',					'Amount',					'5'),  -- Doesn't work!

		('MOD_MNX_ABIL_EMBARK_SIGHT',					'Amount',					'2'),
		('MOD_MNX_ABIL_NAVAL_SIGHT',					'Amount',					'3'),		
		...
		('MOD_MNX_ABIL_RECON_SIGHT',					'Amount',					'2'),			
		('MOD_MNX_ABIL_RECON_EMBARK_SIGHT',				'Amount',					'2'),	-- Has his own mod to enable it before player has a religion	
